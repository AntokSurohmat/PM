    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <a class="btn bg-teal btn-sm" href="<?= base_url('admin/faktorAdd')?>"><i class="fa fa-plus"> Add Data</i></a>
        </div>
      </div>
      <!-- /.box-header -->
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-xs btn-warning" href="<?= base_url('admin/faktorEdit/').$this->encrypt->encode($row->kode_faktor).'';?>" title="Edit"><i class="fa fa-edit"></i></a>
