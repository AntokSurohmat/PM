  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li>PM</li>
      <li><a href="<?= base_url('kandidat/kandidat')?>"><?= $parent ;?></a></li>
      <li><a href="<?= base_url('kandidat/kandidatAdd')?>"><?= $page ;?></a></li>
    </ol>
      ...
      <div class="col-md-10">
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <form class="form-horizontal" action="<?= base_url('kandidat/kandidatAdd')?>" method="post" role="form" >
              ...
              <div class="box-footer justify-content-between">
                <a type="button" class="btn btn-warning" href="<?= base_url('kandidat/kandidat')?>">Batal</a>
