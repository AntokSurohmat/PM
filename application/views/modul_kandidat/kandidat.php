    ...
    <div class="box">
      <div class="box-header">
        ...
        <div class="box-tools pull-right">
          <a class="btn bg-teal btn-sm" href="<?= base_url('kandidat/kandidatAdd')?>"><i class="fa fa-plus"> Add Data</i></a>
        </div>
      </div>
      <!-- /.box-header -->
    ...
    <div class="modal-content">
      <div class="modal-header bg-red">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-danger " href="<?php echo base_url('kandidat/kandidatDelete/'.$this->encrypt->encode($row->id_kandidat).'')?>">Delete</a>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
